    ...
    return <div className={styles['register']}>
        <div className={styles['login-header']}>
            <div className={styles['logo-wrapper']}>
                ...
                <div className={styles['title']}>{pageType === 'login' ? '登录' : '注册'}</div>
            </div>
                    ...
                    {pageType === 'register' ?
                        <>
                            ...
                            <form id="reg-form" className={styles['login-form']}>
                                ...
                                <div className={styles['links']}>已有账号？<a onClick={() => { setPageType('login') }} className={styles['link-text']}>去登录</a>
                                </div>
                            </form>
                        </>
                        : <>
                            <ul className={styles['tabs']}>
                                ...
                                {/* <li>手机动态登录</li> */}
                                <li className={styles['qr']}><span>扫码登录</span></li>
                            </ul>
